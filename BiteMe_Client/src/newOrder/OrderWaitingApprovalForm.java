...
/**
 * This class is the functionality for the OrderWaitingApprovalWindow.
 */
public class OrderWaitingApprovalForm implements IScreenController{
     ...
     * Go to the Home page.
     *
     * @param event - an ActionEvent from the OrderWaitingApprovalWindow
     */
    @FXML
    ...
    /**
     * Logging out of the current account.
     *
     * @param event - an ActionEvent from the OrderWaitingApprovalWindow
     */
    @FXML
	...
	/**
	 * Sets fields and functionality in the OrderWaitingApprovalWindow.
	 */
	@Override
